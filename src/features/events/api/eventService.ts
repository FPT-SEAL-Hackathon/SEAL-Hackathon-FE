...
export interface EventResponse {
  ...
  createdAt: string;
  updatedAt: string;
  eventParticipantId?: number | string | null;
  participantId?: number | string | null;
  participantStatus?: UserParticipationStatus | string | null;
  myRegistrationStatus?: UserParticipationStatus | string | null;
  registrationStatus?: UserParticipationStatus | string | null;
  userParticipationStatus?: UserParticipationStatus | string | null;
...
export function normalizeEventResponse(raw: EventResponse | RawEventRecord): EventResponse {
  ...
  return {
    ...
    eventParticipantId: record.eventParticipantId as EventResponse["eventParticipantId"],
    participantId: record.participantId as EventResponse["participantId"],
    participantStatus: userParticipationStatus,
    myRegistrationStatus: userParticipationStatus,
    registrationStatus: userParticipationStatus,
    userParticipationStatus,
    rejectedReason: stringValue(record.rejectedReason) ?? null,
    appliedAt: stringValue(record.appliedAt) ?? stringValue(record.registeredAt) ?? null,
