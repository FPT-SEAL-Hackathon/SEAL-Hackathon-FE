...
interface Props {
  criterion: EventCriteria;
  onDelete: (criterion: EventCriteria) => void;
}

export function EventCriterionRow({
  criterion,
  onDelete,
}: Props) {
  const { updateEventCriteria } = useEventCriteriaContext();
