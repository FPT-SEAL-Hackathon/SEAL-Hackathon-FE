...
import { eventService, type EventResponse, type CreateEventRequest } from "../../../../app/services/eventService";
import { ApiError } from "../../../../app/services/apiClient";
import { COLORS } from "../../shared/UIComponents";
    ...
    <AnimatePresence>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95, y: 16 }} animate={{ opacity: 1, scale: 1, y: 0 }}
          ...
          style={{ maxWidth: 620, background: COLORS.surface, boxShadow: "0 24px 64px rgba(0,0,0,0.2)", maxHeight: "90vh", overflowY: "auto" }}>
          {/* Header */}
